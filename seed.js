  ...
  try {
    ...
    if (execCount === 0) {
      await Executive.insertMany([
        ...
        { name: 'Emeka Nwofor',       position: 'UNMSA President',          category: 'school-president', school: 'University of Nigeria (Enugu Campus)',           bio: 'Leading the University of Nigeria Medical Students Association (UNMSA).', order: 7 },
        { name: 'Precious Odum',      position: 'ABSUMSA President',        category: 'school-president', school: 'Abia State University, Uturu',                  bio: 'Leading the Abia State University Medical Students Association (ABSUMSA).', order: 8 },
        { name: 'Stanley Nnadi',      position: 'ESUMSA President',         category: 'school-president', school: 'Enugu State University (ESUT)',                 bio: 'Leading the Enugu State University Medical Students Association (ESUMSA).', order: 9 },
        { name: 'Amaka Obiora',       position: 'IMSUMSA President',        category: 'school-president', school: 'Imo State University, Owerri',                  bio: 'Leading the Imo State University Medical Students Association (IMSUMSA).', order: 10 },
        { name: 'Ikenna Ugwueze',     position: 'NAUMSA President',         category: 'school-president', school: 'Nnamdi Azikiwe University, Nnewi',              bio: 'Leading the Nnamdi Azikiwe University Medical Students Association (NAUMSA).', order: 11 },
        { name: 'Chidinma Eze',       position: 'EBSUMSA President',        category: 'school-president', school: 'Ebonyi State University, Abakaliki',            bio: 'Leading the Ebonyi State University Medical Students Association (EBSUMSA).', order: 12 },
        { name: '[Vacant]',           position: 'GOUMSA President',         category: 'school-president', school: 'Godfrey Okoye University',                      bio: 'Leading the Godfrey Okoye University Medical Students Association (GOUMSA). GOUMSA won Academic Mentor of the Year at the most recent regional convention.', order: 13 },
        { name: '[Vacant]',           position: 'GUMSA President',          category: 'school-president', school: 'Gregory University, Uturu',                     bio: 'Leading the Gregory University Medical Students Association (GUMSA) in Abia State.', order: 14 },
        { name: '[Vacant]',           position: 'COOUMSA President',        category: 'school-president', school: 'Chukwuemeka Odumegwu Ojukwu University',        bio: 'Leading the Chukwuemeka Odumegwu Ojukwu University Medical Students Association (COOUMSA) in Anambra State.', order: 15 },
        { name: '[Vacant]',           position: 'AE-FUMSA President',       category: 'school-president', school: 'Alex Ekwueme Federal University, Ebonyi',       bio: 'Leading the Alex Ekwueme Federal University Medical Students Association (AE-FUMSA).', order: 16 },
        { name: '[Vacant]',           position: 'MAUMSA President',          category: 'school-president', school: 'Madonna University, Elele/Okija',               bio: 'Leading the Madonna University Medical Students Association (MAUMSA).', order: 17 },
        { name: '[Vacant]',           position: 'DUFUMSA President',       category: 'school-president', school: 'David Umahi Federal University, Ebonyi',        bio: 'Leading the David Umahi Federal University Medical Students Association (DUFUMSA).', order: 18 },
      ]);
    ...
    if (instCount === 0) {
      await Institution.insertMany([
        ...
        { name: 'Madonna University, Elele/Okija',             acronym: 'MAUMSA',      assoc: 'MAUMSA',       state: 'Imo/Anambra', type: 'Private',  quota: 50,  dental_quota: 0,  status: 'Fully Accredited', order: 11 },
        { name: 'David Umahi Federal University',              acronym: 'DUFUMSA',     assoc: 'DUFUMSA',    state: 'Ebonyi',      type: 'Federal',  quota: 30,  dental_quota: 0,  status: 'Partially Accredited', order: 12 },
      ]);
